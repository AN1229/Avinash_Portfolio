...
import {
  ...
  GraduationCap,
  Mail,
  // MessageCircle, — for "Open AI Chat", switched off with the chat assistant
  Moon,
  Sparkles,
  Sun,
  User,
...
const NAV_ITEMS = [
  { label: "Go to My Journey", id: "journey", icon: User },
  { label: "Go to Projects", id: "projects", icon: FolderGit2 },
  { label: "Go to Experience", id: "experience", icon: Briefcase },
  // { label: "Go to Achievements", id: "achievements", icon: Trophy }, — switched off, see app/page.tsx (also import Trophy)
    ...
    <CommandDialog open={open} onOpenChange={setOpen}>
      ...
      <CommandList>
        ...
        <CommandGroup heading="Actions">
          ...
          {/* Chat assistant switched off for now — see app/page.tsx.
          <CommandItem
            onSelect={() =>
