...
const SUGGESTED_QUESTIONS = [
  `What product experience does ${FIRST_NAME} have?`,
  "How did Skiaverse grow to 5,000 users?",
  `What has ${FIRST_NAME} designed?`,
...
const TEASER = "Ask me how Skiaverse grew";
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            role="dialog"
            aria-modal="false"
            aria-label={`Ask about ${FIRST_NAME}`}
      ...
      <MotionConfig reducedMotion="user">
        ...
        >
          ...
          <button
            ...
            aria-expanded={open}
            aria-label={open ? "Close chat" : `Ask about ${FIRST_NAME}`}
