...
const SYSTEM_PROMPT = `You are a helpful assistant answering questions about ${personal.name},
who is looking for ${personal.role} roles. Answer questions based ONLY on the
